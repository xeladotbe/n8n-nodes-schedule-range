...
steps, and wildcards across 5 or 6 fields, plus the standard 3-letter
month/weekday name aliases (`JAN`-`DEC`, `SUN`-`SAT`, case-insensitive). It
does not support special characters like `L`, `W`, or `#`.
